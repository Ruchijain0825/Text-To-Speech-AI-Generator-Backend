          ...
          <div className="w-[420px] rounded-2xl bg-white p-6 shadow-xl">
            ...
            <div className="mt-6 flex flex-col">
              ...
              <button
                ...
                disabled={loading}
                type="button"
                className="mt-5 w-full rounded-xl bg-gradient-to-r from-blue-400 to-indigo-500 py-3 font-semibold text-white shadow-lg hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60"
              >
