...
const GeneratedAudio = ()=>
{
  ...
  <button className="flex w-25 h-8 items-center justify-center gap-1 rounded-lg border border-gray-200 bg-white text-xs text-gray-600 shadow-sm">
    <RotateCcw size={12} />
    Restart
  </button>
...
<button className="flex w-55 h-8 items-center justify-center gap-1 rounded-lg border border-green-200 bg-white text-xs text-green-600 shadow-sm">
   <Download size ={10}/>
   Download Audio
  </button>
<button className="flex w-55 h-8  items-center justify-center gap-1 rounded-lg border border-red-200 bg-white text-xs text-red-600 shadow-sm">
   <Trash2 size ={10}/>
   Delete
  </button>
  </div>
  ...
  <div className="flex items-start gap-3 rounded-lg bg-white p-3 shadow-sm">
    ...
    <div>
      <h3 className="text-[10px] font-bold text-gray-700">
        Multiple Languages
      </h3>
